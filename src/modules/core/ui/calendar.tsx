  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: 'flex ',
        head_cell: 'text-tertiary-100 w-8 font-bold text-base capitalize',
        ...
        day_selected:
          'bg-secondary text-tertiary-50 rounded-[4px] hover:bg-secondary hover:text-primary-foreground focus:bg-secondary',
        day_today: 'bg-accent text-accent-foreground',
        day_outside:
          'day-outside text-muted-foreground opacity-50  aria-selected:bg-accent/50 aria-selected:text-muted-foreground aria-selected:opacity-30',
        day_disabled: 'text-muted-foreground opacity-50',
        day_range_middle:
          '!rounded-none !text-tertiary font-normal bg-secondary-100',
